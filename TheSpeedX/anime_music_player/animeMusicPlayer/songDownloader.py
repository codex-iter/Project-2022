...
pathToSave = "../musicPlayer/static/music/"
...
def getVidID(song, URL):
    ...
    return soup.body.find_all(class_="yt-uix-tile-link")[0]['href']
...
def doStuff(song):
    ...
    system("youtube-dl -x -q -o \'" + pathToSave +
           titleCase(song) + ".%(ext)s\' \'" + link + "\'")
