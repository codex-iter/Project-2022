...
while(True):
    ...
    if timestr in df.Time.values:
        ...
        webbrowser.open(
            'http://meet.google.com/' + str(df_new.iloc[0, 1]))
        time.sleep(5)

        # # Locate the position of the join button on the screen
        # position = pyautogui.locateOnScreen("button\\video_off.png")
        # print(position)
        ...
        # position = pyautogui.locateOnScreen("button\\capture.png")
        # pyautogui.moveTo(position)
        # pyautogui.click()
        # time.sleep(5)
        ...
        position1 = pyautogui.locateOnScreen("button\\join.png")
        print(position1)
        pyautogui.moveTo(position1)
        pyautogui.click()
        time.sleep(5)

        # # For tapping the Turn off audio option on Zoom app
        # position = pyautogui.locateOnScreen("buttons\\audio_off.png")
        # pyautogui.moveTo(position)
        # pyautogui.click()
        # time.sleep(5)

        # For tapping the Turn off video option on Zoom app
        # position1 = pyautogui.locateOnScreen("button\\joinnow.png")
        # print(position1)
        # pyautogui.moveTo(position1)
        if(position1 != None):
            pyautogui.click()
